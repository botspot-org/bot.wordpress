    ...
    <div class="botspot-admin-root" data-tab="connect">
        ...
        <header class="bsa-header">
            <div class="bsa-header__brand">
                ...
                <span class="bsa-header__divider"></span>
                <span class="bsa-header__subtitle"><?php _e("WordPress plugin", "botdot-wp"); ?></span>
            </div>

            <div class="bsa-header__status">
                <div class="bsa-status-pill" data-bsa-status="connection" title="<?php esc_attr_e("Checking connection...", "botdot-wp"); ?>">
                    <span class="bsa-dot bsa-dot--pending"></span>
                    <span class="bsa-status-pill__label"><?php _e("Connection", "botdot-wp"); ?></span>
                </div>
                <span class="bsa-header__divider bsa-header__divider--tiny"></span>
                <div class="bsa-status-pill" data-bsa-status="sync" title="<?php esc_attr_e("Checking sync...", "botdot-wp"); ?>">
                    <span class="bsa-dot bsa-dot--pending"></span>
                    <span class="bsa-status-pill__label"><?php _e("Sync", "botdot-wp"); ?></span>
                </div>
                <span class="bsa-header__divider bsa-header__divider--tiny"></span>
                <div class="bsa-status-pill" data-bsa-status="runtime" title="<?php esc_attr_e("Checking runtime...", "botdot-wp"); ?>">
                    <span class="bsa-dot bsa-dot--pending"></span>
                    <span class="bsa-status-pill__label"><?php _e("Runtime", "botdot-wp"); ?></span>
                </div>
                <span class="bsa-header__divider"></span>
        ...
        <form method="post" action="options.php" id="bsa-settings-form" class="bsa-form">
            ...
            <main class="bsa-panel" data-bsa-panel="connect">
                <?php require BOTDOT_WP_PLUGIN_PATH . "admin/partials/tab-connect.php"; ?>
            </main>
