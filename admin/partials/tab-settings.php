...
<div class="bsa-settings">
    ...
    <div class="bsa-section-head bsa-reveal bsa-reveal--1">
        <h1 class="bsa-h1"><?php esc_html_e("Settings", "botspot-wp"); ?></h1>
        <p class="bsa-description">
            <?php esc_html_e("Optional WordPress-specific runtime settings. Content, review flow, styling, and publishing are managed in bot.spot.", "botspot-wp"); ?>
        </p>
    </div>
    ...
    <section class="bsa-settings-row bsa-reveal bsa-reveal--2">
        <div class="bsa-settings-row__meta">
            <h3 class="bsa-settings-row__title">
                <?php esc_html_e("Content to sync", "botspot-wp"); ?>
                ...
                <a href="<?php echo esc_url($bsa_dashboard_url); ?>" target="_blank" rel="noopener" class="bsa-managed-link">
                    <?php esc_html_e("Managed in bot.spot", "botspot-wp"); ?> ↗
                </a>
                <?php endif; ?>
            </h3>
            <p class="bsa-settings-row__desc">
                <?php esc_html_e("Updates for selected types are automatically pushed to bot.spot.", "botspot-wp"); ?>
            </p>
        </div>
        <div class="bsa-settings-row__body">
            ...
            <div class="bsa-readonly-list">
                ...
                <span class="bsa-readonly-item bsa-readonly-item--none"><?php esc_html_e("None selected", "botspot-wp"); ?></span>
                <?php endif; ?>
            </div>
            <?php else: ?>
            <div class="bsa-check-list">
                ...
                <label class="bsa-check <?php echo $bsa_woocommerce_active ? "" : "bsa-check--disabled"; ?>">
                    ...
                    <span>
                        <?php esc_html_e("Products", "botspot-wp"); ?>
                ...
                <details class="bsa-check bsa-check-group">
                    <summary><?php esc_html_e("Custom post types", "botspot-wp"); ?></summary>
                ...
                <label class="bsa-check bsa-check--disabled">
                    ...
                    <span><?php esc_html_e("Custom post types", "botspot-wp"); ?></span>
                </label>
                <?php endif; ?>
            </div>
            <?php endif; ?>
    ...
    <section class="bsa-settings-row bsa-reveal bsa-reveal--3">
        <div class="bsa-settings-row__meta">
            <h3 class="bsa-settings-row__title">
                <?php esc_html_e("Placement", "botspot-wp"); ?>
                <?php if ($bsa_is_platform_managed): ?>
                <a href="<?php echo esc_url($bsa_dashboard_url); ?>" target="_blank" rel="noopener" class="bsa-managed-link">
                    <?php esc_html_e("Managed in bot.spot", "botspot-wp"); ?> ↗
                </a>
            ...
            <p class="bsa-settings-row__desc"><?php esc_html_e("Where the appendix is injected into the page.", "botspot-wp"); ?></p>
        </div>
        <div class="bsa-settings-row__body">
            <?php if ($bsa_is_platform_managed): ?>
            <?php
            ...
            <div class="bsa-check-list">
                <label class="bsa-check">
                    ...
                    <span>
                        <?php esc_html_e("Bottom of content", "botspot-wp"); ?>
                        <span class="bsa-check__tag"><?php esc_html_e("recommended", "botspot-wp"); ?></span>
                    </span>
                </label>
                <label class="bsa-check">
                    ...
                    <span><?php esc_html_e("Above footer", "botspot-wp"); ?></span>
                </label>
                <label class="bsa-check">
                    ...
                    <span><?php esc_html_e("Bottom of page", "botspot-wp"); ?></span>
                </label>
                <label class="bsa-check">
                    ...
                    <span>
                        <?php esc_html_e("Manual placement", "botspot-wp"); ?>
            ...
            <p class="bsa-settings-row__note" id="bsa-footer-detection-note" style="display: none;">
                <strong><?php esc_html_e("Note:", "botspot-wp"); ?></strong>
                <?php esc_html_e("Footer detection relies on common HTML patterns (<code>&lt;footer&gt;</code>, <code>role=\"contentinfo\"</code>, etc.). If your theme uses a non-standard footer, add the attribute <code>data-botspot-footer</code> to your footer element for reliable placement.", "botspot-wp"); ?>
            </p>
            <?php endif; ?>
        </div>
    </section>
    ...
    <section class="bsa-settings-row bsa-reveal bsa-reveal--4">
        <div class="bsa-settings-row__meta">
            <h3 class="bsa-settings-row__title"><?php esc_html_e("SEO compatibility", "botspot-wp"); ?></h3>
            <p class="bsa-settings-row__desc"><?php esc_html_e("How JSON-LD output interacts with other SEO plugins.", "botspot-wp"); ?></p>
        </div>
        <div class="bsa-settings-row__body">
            <div class="bsa-check-list">
                <label class="bsa-check">
                    ...
                    <span>
                        <?php esc_html_e("Merge with existing output", "botspot-wp"); ?>
                        <span class="bsa-check__tag"><?php esc_html_e("recommended", "botspot-wp"); ?></span>
                    </span>
                </label>
                <label class="bsa-check">
                    ...
                    <span><?php esc_html_e("Replace conflicting output", "botspot-wp"); ?></span>
                </label>
            </div>
        </div>
    </section>
    ...
    <details class="bsa-advanced bsa-reveal bsa-reveal--4">
        <summary class="bsa-advanced__summary">
            <span><?php esc_html_e("Advanced", "botspot-wp"); ?></span>
            <span class="bsa-advanced__chevron" aria-hidden="true">▸</span>
        </summary>

        <section class="bsa-settings-row">
            <div class="bsa-settings-row__meta">
                <h3 class="bsa-settings-row__title"><?php esc_html_e("Auto-sync on publish", "botspot-wp"); ?></h3>
                <p class="bsa-settings-row__desc"><?php esc_html_e("Automatically push content changes to bot.spot on save.", "botspot-wp"); ?></p>
            </div>
            <div class="bsa-settings-row__body">
                <label class="bsa-check">
                    <input type="checkbox" name="bspt_auto_sync_enabled" value="1" <?php checked($bsa_auto_sync); ?> />
                    <span><?php esc_html_e("Enable auto-sync", "botspot-wp"); ?></span>
                </label>
            </div>
        </section>
        ...
        <section class="bsa-settings-row">
            <div class="bsa-settings-row__meta">
                <h3 class="bsa-settings-row__title">
                    <?php esc_html_e("Output toggles", "botspot-wp"); ?>
                    <?php if ($bsa_is_platform_managed): ?>
                    <a href="<?php echo esc_url($bsa_dashboard_url); ?>" target="_blank" rel="noopener" class="bsa-managed-link">
                        <?php esc_html_e("Managed in bot.spot", "botspot-wp"); ?> ↗
                    </a>
                ...
                <p class="bsa-settings-row__desc"><?php esc_html_e("Disable specific injection outputs.", "botspot-wp"); ?></p>
            </div>
            <div class="bsa-settings-row__body">
                <?php if ($bsa_is_platform_managed): ?>
                <div class="bsa-readonly-toggles">
                    <span class="bsa-readonly-toggle <?php echo $bsa_appendix_enabled ? 'bsa-readonly-toggle--on' : 'bsa-readonly-toggle--off'; ?>">
                        <?php esc_html_e("HTML appendix", "botspot-wp"); ?>: <?php echo $bsa_appendix_enabled ? esc_html__("Enabled", "botspot-wp") : esc_html__("Disabled", "botspot-wp"); ?>
                    </span>
                    <span class="bsa-readonly-toggle <?php echo $bsa_jsonld_enabled ? 'bsa-readonly-toggle--on' : 'bsa-readonly-toggle--off'; ?>">
                        <?php esc_html_e("JSON-LD structured data", "botspot-wp"); ?>: <?php echo $bsa_jsonld_enabled ? esc_html__("Enabled", "botspot-wp") : esc_html__("Disabled", "botspot-wp"); ?>
                    </span>
                </div>
                <?php else: ?>
                <div class="bsa-check-list">
                    <label class="bsa-check">
                        ...
                        <span><?php esc_html_e("HTML appendix", "botspot-wp"); ?></span>
                    </label>
                    <label class="bsa-check">
                        <input type="checkbox" name="bspt_jsonld_enabled" value="1" <?php checked($bsa_jsonld_enabled); ?> />
                        <span><?php esc_html_e("JSON-LD structured data", "botspot-wp"); ?></span>
                    </label>
                </div>
                <?php endif; ?>
            </div>
        ...
        <section class="bsa-settings-row">
            <div class="bsa-settings-row__meta">
                <h3 class="bsa-settings-row__title">
                    <?php esc_html_e("Inject on post types", "botspot-wp"); ?>
                    <?php if ($bsa_is_platform_managed): ?>
                    <a href="<?php echo esc_url($bsa_dashboard_url); ?>" target="_blank" rel="noopener" class="bsa-managed-link">
                        <?php esc_html_e("Managed in bot.spot", "botspot-wp"); ?> ↗
                    </a>
                ...
                <p class="bsa-settings-row__desc"><?php esc_html_e("Override which post types receive injected output (defaults to synced types).", "botspot-wp"); ?></p>
            </div>
            <div class="bsa-settings-row__body">
                <?php if ($bsa_is_platform_managed): ?>
                <div class="bsa-readonly-list">
    ...
    <div class="bsa-save-bar">
        <span class="bsa-save-bar__status" data-bsa-save-status><?php esc_html_e("All changes saved", "botspot-wp"); ?></span>
        <div class="bsa-save-bar__actions">
            <button type="button" class="bsa-btn" data-bsa-action="reset-form">
                <?php esc_html_e("Reset", "botspot-wp"); ?>
            </button>
            <button type="submit" class="bsa-btn bsa-btn--primary" name="submit">
                <?php esc_html_e("Save changes", "botspot-wp"); ?>
            </button>
        </div>
    </div>
</div>
