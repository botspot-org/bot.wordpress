    ...
    <div class="bsa-connect__grid">
        ...
        <section class="bsa-reveal bsa-reveal--1">
            <div class="bsa-section-head">
                <h1 class="bsa-h1">
                    <?php esc_html_e("Connect your", "botspot-wp"); ?>
                    <span class="bsa-h1__accent"><?php esc_html_e("site", "botspot-wp"); ?></span>
                </h1>
                <p class="bsa-description">
                    <?php esc_html_e("Paste your access key to connect this WordPress site to bot.spot. Content, review, and publishing are managed there.", "botspot-wp"); ?>
                </p>
            </div>

            <div class="bsa-field">
                <label class="bsa-label" for="bsa-api-key"><?php esc_html_e("Access key", "botspot-wp"); ?></label>
                <div class="bsa-input-group" data-bsa-component="api-key-input">
                    ...
                    <button type="button" class="bsa-input-group__affix" data-bsa-action="toggle-key-visibility">
                        <?php esc_html_e("Show", "botspot-wp"); ?>
                    </button>
                </div>
                <?php if ($bsa_has_api_key): ?>
                    <p class="bsa-help"><?php esc_html_e("Leave empty to keep the current key.", "botspot-wp"); ?></p>
                <?php endif; ?>
            </div>
        ...
        <aside class="bsa-connect__sidebar bsa-reveal bsa-reveal--2">
            <div class="bsa-card">
                <div class="bsa-card__head">
                    <span class="bsa-card__title"><?php esc_html_e("Setup guide", "botspot-wp"); ?></span>
                </div>
                <ol class="bsa-steps">
                    <li class="bsa-step">
                        ...
                        <div class="bsa-step__body">
                            <p class="bsa-step__title">
                                <a href="https://platform.bot.spot/integrations" target="_blank" rel="noopener"><?php esc_html_e("Sign in to bot.spot", "botspot-wp"); ?></a>
                            </p>
                            <p class="bsa-step__desc"><?php esc_html_e("Use your workspace account.", "botspot-wp"); ?></p>
                        </div>
                    </li>
                    <li class="bsa-step">
                        <span class="bsa-step__num">2</span>
                        <div class="bsa-step__body">
                            <p class="bsa-step__title"><?php esc_html_e("Go to Integrations", "botspot-wp"); ?></p>
                            <p class="bsa-step__desc"><?php esc_html_e("Find the WordPress card in your workspace.", "botspot-wp"); ?></p>
                        </div>
                    </li>
                    <li class="bsa-step">
                        <span class="bsa-step__num">3</span>
                        <div class="bsa-step__body">
                            <p class="bsa-step__title"><?php esc_html_e("Generate an access key", "botspot-wp"); ?></p>
                            <p class="bsa-step__desc"><?php esc_html_e("Copy it to your clipboard.", "botspot-wp"); ?></p>
                        </div>
                    </li>
                    <li class="bsa-step bsa-step--active">
                        <span class="bsa-step__num">4</span>
                        <div class="bsa-step__body">
                            <p class="bsa-step__title"><?php esc_html_e("Paste it here and connect", "botspot-wp"); ?></p>
                            <p class="bsa-step__desc"><?php esc_html_e("You're done.", "botspot-wp"); ?></p>
                        </div>
                    </li>
                </ol>
            </div>
            ...
            <div class="bsa-card bsa-card--accent">
                ...
                <div class="bsa-card__body">
                    <div class="bsa-next-step__head">
                        ...
                        <span class="bsa-next-step__label"><?php esc_html_e("Next step", "botspot-wp"); ?></span>
                    </div>
                    <h3 class="bsa-next-step__title">
                        <?php esc_html_e("Open bot.optimizer to generate, review, and publish your content.", "botspot-wp"); ?>
                    </h3>
                    <p class="bsa-next-step__desc">
                        <?php esc_html_e("Your appendix, schema, and styling live in bot.optimizer. This plugin handles syncing and injection automatically.", "botspot-wp"); ?>
                    </p>
                    <a href="https://platform.bot.spot/optimizer" target="_blank" rel="noopener" class="bsa-btn bsa-btn--ghost">
                        <?php esc_html_e("Open bot.optimizer", "botspot-wp"); ?>
                        <svg class="bsa-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="square" d="M7 17L17 7M17 7H9M17 7v8"/></svg>
                    </a>
                </div>
            </div>
