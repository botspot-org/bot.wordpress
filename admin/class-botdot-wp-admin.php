...
class BotDot_WP_Admin {
    ...
    public function add_admin_menu() {
        ...
        add_menu_page(
            __('BotSpot Settings', 'botdot-wp'),  // Page title
            __('BotSpot', 'botdot-wp'),           // Menu title
    ...
    public function render_general_section() {
        echo '<p>' . __('Configure the basic settings for BotSpot WP.', 'botdot-wp') . '</p>';
    }
    ...
    public function render_mirror_domain_field() {
        ...
        <p class="description">
            <?php _e('Your BotSpot mirror domain. Examples: ai.example.com, localhost:5000', 'botdot-wp'); ?>
        </p>
    ...
    public function handle_test_connection() {
        ...
        // Get domain from POST (current input value) or fall back to saved option
        $domain = isset($_POST['domain']) ? sanitize_text_field($_POST['domain']) : '';

        $result = BotDot_WP_Fetcher::test_connection('/', $domain);
